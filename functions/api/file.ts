...
// Validates the short-lived signature from /api/download, then streams the
// gated template file from the private R2 bucket. This keeps template files
// OUT of your public repo/site so they can't be bulk-scraped.
